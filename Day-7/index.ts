...
let guestListInv = ["mubeen", "ali","javed","musk sahab", "areeb"];

console.log(`Hello guys, our dinner going to be big bacuse i am invaitting: ${guestListInv.length}`);
...
let cities = ["Turkey", "New York", "UAE", "Karachi", "swiss"];
console.log("The places i want to visit",  cities)
...
let car: {car: string; color: string; model:number; features:string} = {
    car: "BMW",
    color: "black",
    model: 2020,
    features: "automatic system etc"
};


console.log(`${car.car} with ${car.color} color and the model is ${car.model}, and comes with features ${car.features}`);
